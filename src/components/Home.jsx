...
export default function Home() {
  ...
  return (
    <section id='home' className={styles.one}>
      ...
      <a target="_blank" href='https://drive.google.com/file/d/1xbvsoEDE4DZMUaGlF8dTmldYCGzE24tZ/view?usp=sharing' className={`${styles.button_33} ${styles.hidden}`} >Download CV</a>
      </div>
    </section>
  )
}